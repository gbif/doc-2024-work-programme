...
*** *Expected funding mechanisms and sources*: Salaried staff apart from: external contract to coordinate Data4Nature initiative (€45,000 core funds), meeting costs for forum (€45,000 core funds, potential supplementary funds from Data4Nature partners)
