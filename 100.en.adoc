...
*** *Expected funding mechanisms and sources*: Salaried staff, core funds, external contracts, supplementary funds, non-salary expenses, and https://www.gatesfoundation.org/[Bill & Melinda Gates Foundation^] (Vector Atlas)
